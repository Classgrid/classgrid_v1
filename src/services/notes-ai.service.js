...
export async function verifyAndSummarize(noteContent, noteTitle) {
    const prompt = `You are an academic content verifier for Classgrid, an intelligent classroom ecosystem.
...
export async function generateQuizFromContent(noteContent, noteTitle) {
    const prompt = `You are a quiz generator for Classgrid, an intelligent classroom ecosystem.
